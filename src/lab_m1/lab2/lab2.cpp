...
void Lab2::Init()
{
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices =
        {
            ...
            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(1,  1, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(2, 1, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0))
        };
