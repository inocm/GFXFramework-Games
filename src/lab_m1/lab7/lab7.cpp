...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.0f, 0.0f, 1.0f));
    }
    ...
    // Render the point light in the scene
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["Simple"], modelMatrix, glm::vec3(0.0f, 0.0f, 1.0f));
    }
}
